...
public class WorkerPayrollQueryEntity extends BaseEntity {
    // 平台为项目分配的接入编码（必填）
    ...
    private List<DetailListQueryEntity> detailList;
    ...
    public List<DetailListQueryEntity> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<DetailListQueryEntity> detailList) {
